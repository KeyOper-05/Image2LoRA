"""LightLoRA adapter for Stable Diffusion 1.5 UNet (adapted from Video2LoRA)."""
...
# SD 1.5 UNet attention linear layers to inject LightLoRA
...
class LoRANetwork(torch.nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        print(f"Creating LightLoRA network. rank={rank}, alpha={alpha}, aux={down_dim}/{up_dim}")
        ...
        print(f"LightLoRA modules: TE={len(self.text_encoder_loras)}, UNet={len(self.unet_loras)}")
